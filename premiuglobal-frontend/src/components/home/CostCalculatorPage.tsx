...
/* â”€â”€ Shipping rate table (USD per kg) â”€â”€ */
...
/* The per-kg rates above are in USD. We show the customer the cost in BDT (à§³),
...
const CostCalculatorPage: React.FC = () => {
    ...
    const calculate = () => {
        ...
        /* Volumetric weight: LÃ—WÃ—H / 5000 for air, /6000 for sea (cmâ†’kg) */
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base">ðŸŒ</span>
                                </div>
                            </div>
                            <div>
                                <label className="block text-xs font-semibold text-gray-500 mb-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-gray-500 mb-1">
                                    ...
                                    <span className="font-normal text-gray-400">(optional â€” for volumetric weight)</span>
                                </label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-white rounded-xl p-5 border-2 border-[var(--color-primary)] shadow-sm">
                                    <div className="flex items-center justify-between mb-1">
                                        <p className="text-sm font-semibold text-gray-600">âœˆï¸ By Air</p>
                                    ...
                                    <p className="text-2xl font-extrabold text-[var(--color-text-primary)]">
                                        à§³{toBDT(result.airCost).toLocaleString()}
                                    </p>
                                    <p className="text-xs text-gray-400 mt-0.5">â‰ˆ ${result.airCost.toFixed(2)} USD Â· Est. 7â€“14 business days</p>
                                </div>
                                <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
                                    <div className="flex items-center justify-between mb-1">
                                        <p className="text-sm font-semibold text-gray-600">ðŸš¢ By Sea</p>
                                        <span className="text-xs bg-green-100 text-green-600 px-2 py-0.5 rounded-full font-semibold">Economical</span>
                                    </div>
                                    <p className="text-2xl font-extrabold text-gray-800">
                                        à§³{toBDT(result.seaCost).toLocaleString()}
                                    </p>
                                    <p className="text-xs text-gray-400 mt-0.5">â‰ˆ ${result.seaCost.toFixed(2)} USD Â· Est. 25â€“40 business days</p>
                                </div>
                            </div>
                            <p className="text-xs text-gray-400 mt-4 flex items-center gap-1">
                                <FiInfo size={12} />
                                These are estimates only (BDT converted at à§³{USD_TO_BDT}/USD). Final rates may vary based on actual shipment details, customs and surcharges.
                            </p>
                        </div>
                    )}
                    ...
                    <div className="relative bg-white border-t border-gray-100 px-8 py-10 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="flex-shrink-0 text-[90px] select-none flex flex-col items-center">
                                <span>âœˆï¸</span>
                                <span className="text-4xl mt-[-10px]">ðŸ“</span>
                            </div>
                        </div>
                    </div>
