...
const stepDetails = [
    ...
    },
    {
        ...
        subtitle: 'Step 2 â€” Review & Start Shipping',
        bullets: [
        ...
        note: "We support multiple shipping types â€” By Air and By Ship â€” to suit your timeline and budget.",
        note2: "Choose Cargo, International, or P2P shipping type based on your needs.",
    },
    {
        title: 'Product Received at Source Warehouse',
        subtitle: 'Step 3 â€” We Handle the Rest',
        bullets: [
    ...
    },
    {
        ...
        subtitle: 'Step 4 â€” Create Delivery Request',
        bullets: [
    ...
    },
    {
        ...
        subtitle: 'Step 5 â€” Final Delivery',
        bullets: [
        ...
        <div className="min-h-screen bg-[var(--color-background)]">
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="flex-1 flex justify-center">
                        <div className="relative w-full max-w-md h-64 flex items-center justify-center">
                            {/* Airplane */}
                            <div className="absolute top-0 right-8 text-8xl select-none" style={{ transform: 'rotate(-10deg)' }}>âœˆï¸</div>
                            {/* Truck */}
                            <div className="absolute bottom-4 left-4 text-7xl select-none">ðŸšš</div>
                            {/* Globe */}
                            <div className="absolute bottom-2 right-12 text-6xl select-none">ðŸŒ</div>
                            {/* Boxes */}
                            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-5xl select-none">ðŸ“¦</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="w-full py-14 px-4 bg-white">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="flex-1 flex justify-center">
                        <div className="text-[120px] select-none">ðŸ§®</div>
                    </div>
                </div>
            </section>

            {/* â”€â”€ Ready to Start CTA â”€â”€ */}
