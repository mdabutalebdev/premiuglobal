...
const SiteContentController = {
    ...
    updateSection: catchAsync(async (req: Request, res: Response) => {
        ...
        const validSections = ['ticker', 'contact', 'floating', 'footer', 'defaultTagline', 'seo', 'announcement', 'legalPages', 'homeSections', 'navMenu', 'topSelling', 'heroSlides', 'heroSideBanners'];
